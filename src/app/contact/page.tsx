    ...
    <div className="flex flex-col">
      ...
      <section className="relative py-12">
        <div className="absolute inset-0 z-0">
          <Image
            src="/california-farm-mountains.png"
          ...
          <div className="grid gap-10 md:grid-cols-2">
            ...
            <div>
              ...
              <div className="mb-8 overflow-hidden rounded-lg">
                <div className="relative h-[300px] w-full">
                  <Image
                    src="/farm-business-owners-mountains.png"
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:pinapicantesalsa@gmail.com"
                      className="text-muted-foreground hover:text-primary transition-colors"
                    >
                      pinapicantesalsa@gmail.com
                    </a>
                  </div>
                </div>
              </div>

              {/* Remove the Map section completely */}
            </div>
            ...
            <div>
              ...
              <div className="mt-8 rounded-lg border border-border bg-card p-6 shadow-sm">
                <h3 className="mb-4 text-xl font-bold text-secondary">Frequently Asked Questions</h3>
                <div className="space-y-4">
                  <div>
                    <h4 className="font-medium text-secondary">Lorem ipsum dolor sit amet?</h4>
                  ...
                  <div>
                    <h4 className="font-medium text-secondary">Consectetur adipiscing elit?</h4>
                    <p className="text-sm text-muted-foreground">
                  ...
                  <div>
                    <h4 className="font-medium text-secondary">Ut enim ad minim veniam?</h4>
                    <p className="text-sm text-muted-foreground">
