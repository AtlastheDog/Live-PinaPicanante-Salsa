        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            ...
            <div className="group overflow-hidden rounded-lg bg-white shadow-md transition-all hover:shadow-lg">
              <div className="relative h-64 overflow-hidden">
                <Image
                  src="/placeholder.svg?height=400&width=600&query=bottle of garlic serrano hot sauce"
                  alt="Garlic Serrano Hot Sauce"
                  fill
                  className="object-cover object-center transition-transform duration-300 group-hover:scale-105"
                />
              </div>
              <div className="p-4">
                <h3 className="mb-1 text-lg font-bold text-secondary">Garlic Serrano</h3>
                <p className="mb-2 text-sm text-muted-foreground">
                  Bold garlic flavor with the bright heat of serrano peppers.
                </p>
                <div className="mb-3 flex items-center gap-1">
                  <span className="text-xs font-medium text-secondary">Heat Level:</span>
                  <div className="flex">
            ...
            <div className="group overflow-hidden rounded-lg bg-white shadow-md transition-all hover:shadow-lg">
              <div className="relative h-64 overflow-hidden">
                <Image
                  src="/placeholder.svg?height=400&width=600&query=gift box with three hot sauce bottles"
              ...
              <div className="p-4">
                <h3 className="mb-1 text-lg font-bold text-secondary">Trio Gift Set</h3>
                <p className="mb-2 text-sm text-muted-foreground">
                  Our three most popular salsas in an elegant gift box.
                </p>
                <div className="mb-3 flex items-center gap-1">
                  <span className="text-xs font-medium text-secondary">Includes:</span>
                  <span className="text-xs text-muted-foreground">Original, Jalapeño Lime, Pineapple Habanero</span>
                </div>
                <div className="flex items-center justify-between">
            ...
            {/* Product 7 - Merchandise */}
            <div className="group overflow-hidden rounded-lg bg-white shadow-md transition-all hover:shadow-lg">
              <div className="relative h-64 overflow-hidden">
                <Image
                  src="/placeholder.svg?height=400&width=600&query=vintage style t-shirt with hot sauce logo"
                  alt="Hot Sauce T-Shirt"
                  fill
                  className="object-cover object-center transition-transform duration-300 group-hover:scale-105"
                />
              </div>
              <div className="p-4">
                <h3 className="mb-1 text-lg font-bold text-secondary">Vintage Logo T-Shirt</h3>
                <p className="mb-2 text-sm text-muted-foreground">
                  100% cotton t-shirt featuring our vintage logo design.
                </p>
                <div className="mb-3 flex items-center gap-1">
                  <span className="text-xs font-medium text-secondary">Sizes:</span>
                  <span className="text-xs text-muted-foreground">S, M, L, XL, XXL</span>
                </div>
                <div className="flex items-center justify-between">
            ...
            {/* Product 8 - Merchandise */}
            <div className="group overflow-hidden rounded-lg bg-white shadow-md transition-all hover:shadow-lg">
              <div className="relative h-64 overflow-hidden">
                <Image
                  src="/placeholder.svg?height=400&width=600&query=canvas tote bag with hot sauce logo"
                  alt="Canvas Tote Bag"
                  fill
                  className="object-cover object-center transition-transform duration-300 group-hover:scale-105"
                />
              ...
              <div className="p-4">
                <h3 className="mb-1 text-lg font-bold text-secondary">Canvas Tote Bag</h3>
                <p className="mb-2 text-sm text-muted-foreground">
                  Durable canvas tote featuring our vintage logo design.
                </p>
                <div className="mb-3 flex items-center gap-1">
                  <span className="text-xs font-medium text-secondary">Details:</span>
                  <span className="text-xs text-muted-foreground">100% organic cotton, 15" x 16"</span>
                </div>
                <div className="flex items-center justify-between">
